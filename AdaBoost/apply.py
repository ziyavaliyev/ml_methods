...
syn = io.loadmat('/Users/ziya03/Github/ml_methods/AdaBoost/synthetic.mat')  # ... or load existing dataset
X = syn['X']
Y = syn['Y']
...
usps = io.loadmat('/Users/ziya03/Github/ml_methods/AdaBoost/usps.mat')   # Load USPS dataset
X = usps['X']
Y = usps['Y']
kMax = 50       # Number of weak classifiers
